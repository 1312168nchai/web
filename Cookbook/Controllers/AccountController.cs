...
namespace Cookbook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult FacebookLogin(string token)
        {
            ...
            try
            {
                var json = client.DownloadString(String.Format("https://appharbor.com/applications/server-13/api/NguoiDung/Get/{0}", id));
            ...
            catch
            {
                ...
                Account account = new Account("kcpm", "653182712165325", "TvT8gNQxWwf_ZN9IkKS2vW1zptk");
